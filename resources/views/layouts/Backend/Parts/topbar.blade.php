        ...
        <div class="navbar-container content">
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{empty(Auth::User()->name)?'':Auth::User()->name}}</span><span class="user-status">Available</span></div><span><img class="round" src="{{asset('Backend/app-assets/images/portrait/small/avatar-s-11.jpg')}}" alt="avatar" height="40" width="40"></span>
                        </a>
                        ...
                        <a class="dropdown-item" href="{{route('admin.settings')}}"><i class="feather icon-settings"></i>Settings</a>
